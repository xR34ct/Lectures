...
\begin{vmatrix}
	...
	x_2 & x_1
\end{vmatrix}
= x_1-x_2\) och i \eqref{eq:7.4} \(\frac{\mathrm{d}(x,y)}{\mathrm{d}(\rho,\varphi)} = \rho\cos^2{\varphi} + \rho\sin^2{\varphi} = \rho\)
...
$$
	\iint_D f(x,y) \,\mathrm{d}x\,\mathrm{d}y = \underbrace{\iint_\triangle f_\mathrm{d}(x,y) \,\mathrm{d}x\,\mathrm{d}y}_{\text{definerat i \vref{sec:Steg 2}}}
$$
